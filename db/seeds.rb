...
c.save!
d = Consultation.new(patient_id: a.id, status: 'Upcoming', start_time: '22/08/2019 09:00AM', end_time: '22/08/2019 09:30AM', consultation_type: "Consultation")
d.save!
...
Consultation.all.each do |c|
  if c.start_time.day == 25 || c.start_time.day == 01
    c.destroy
  end
end
